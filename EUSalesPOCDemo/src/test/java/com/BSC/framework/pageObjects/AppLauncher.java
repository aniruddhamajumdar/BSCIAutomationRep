...
public class AppLauncher extends BaseTest {
	...
	@FindBy(how = How.XPATH, using = "//ul/li/a[@title='Accounts']")
	...
	@FindBy(how = How.XPATH, using = "(//a[@title='Contacts'])[2]")
	...
	public void clickAndSearchContacts() throws InterruptedException {
		link_applauncher.click();
		Thread.sleep(3000);
		driver.switchTo().defaultContent();
		search.sendKeys(Constants.searchContacts);
		Thread.sleep(3000);
		clickContacts.click();
		Thread.sleep(6000);
