...
public class VFPages extends BaseTest {
	...
	public static void startTest() throws Exception {
		...
		setup();
		report = new ExtentReports("C:\\Users\\s.satish.vibhute\\BSC\\BSCAutomation\\ExtentReportResults.html");
		test = report.startTest("Automation-DemoNew");
		report.loadConfig(new File("C:\\Users\\s.satish.vibhute\\BSC\\BSCAutomation\\extent-config.xml"));
	...
	public void searchAndSelect() throws Exception {
		...
		try {
			...
			//WebDriverActionKeywordsGeneric.selectAccountAndAccountPerformanceNew(driver);
		} catch (Exception e) {
	...
	public void selectAndValidateAcctPerformance() throws Exception {

		try {
			//WebDriverActionKeywordsGeneric.validateAccountPerformance(driver);
	...
	/*@Test(dependsOnMethods = "selectAndValidateAcctPerformance", alwaysRun = true)
	public void selectAndValidatePotential() throws Exception {

		try {
			WebDriverActionKeywordsGeneric.validatePotentialInAccountPerf(driver);
			//WebDriverActionKeywordsGeneric.setQuantityProposed(driver);
			//WebDriverActionKeywordsGeneric.checkValidation(driver);
